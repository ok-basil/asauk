                    ...
                    <div class="events-container">
                        <div class="first-event" id="first-event" style="background-image: url('<?php echo get_template_directory_uri(); ?> /assets/img/events-1.png')">
                            ...
                            <div class="second-half" id="second-half">
                                ...
                                <h6>Eget nulla facilisi etiamd dignissim diam quis enim lobortis scelerisque. Eu feugiat pretium nibh ipsum consequat nisl vel pretium. Eget nulla facilisi etiam dignissim diam quis enim.</h6>
